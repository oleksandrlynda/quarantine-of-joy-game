...
- Propaganda Pelican 100 HP → 3 body; one headshot; large aerial priority target
...
## Wave pacing model
- Size: `count = 3 + wave`
- Composition unlocks: Rusher≥3, Shooter≥4, Flyer≥5, Tank≥6, Healer≥7, Sniper≥8, Propaganda Pelican≥10 (see `enemies.md`)
...
- Propaganda Pelican grenade: 22 centre / 6 edge damage in a 2.6-unit radius; 5–7-unit release band; 3.5–4.5s recharge after retreat
